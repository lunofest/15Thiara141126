const CACHE_NAME = 'cache-v47'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v47',
    'estilos/styles.css?v47',
    'estilos/mediaQueries.css?v47',
    'javascript/script.js?v47',
